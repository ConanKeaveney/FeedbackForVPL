...
In order to connect to the university mail server, it is required that you you use a machine that is on the cs.nuim network and that you have a user on that network.
This directory also contains the screencast of the main features of the project working in a live session.
